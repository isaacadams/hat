...
200 OK http://localhost:5000/200 HTTP/1.1
✅ status only, no headers or body
  ✅ 200 == 200

200 OK http://localhost:5000/message HTTP/1.1
...
200 OK http://localhost:5000/posts HTTP/1.1
...
200 OK http://localhost:5000/posts/1 HTTP/1.1
✅ text body works
  ✅ 200 == 200
  ✅ "how to build a CLI program in rust" == "how to build a CLI program in rust"

201 Created http://localhost:5000/posts HTTP/1.1
✅ show example of querying arrays in response
  ✅ 201 == 201
